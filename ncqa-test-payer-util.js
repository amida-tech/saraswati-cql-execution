...
const medicareMeasures = ['aab', 'asfe', 'aise', 'bcse', 'cole', 'cou', 'cwp', 'dmse', 'drre', 'dsfe', 'fum', 'psa'];
const medicaidMeasures = ['aab', 'adde', 'apme', 'aise', 'asfe', 'bcse', 'ccs', 'cise', 'cole', 'cou', 'cwp', 'dmse', 'drre', 'dsfe', 'fum', 'imae', 'pdse', 'pnde'];
